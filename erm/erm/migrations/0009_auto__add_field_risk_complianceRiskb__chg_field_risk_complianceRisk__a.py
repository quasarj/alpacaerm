...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Risk.complianceRiskb'
        db.add_column('erm_risk', 'complianceRiskb',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Risk.complianceRisk'
        db.alter_column('erm_risk', 'complianceRisk', self.gf('django.db.models.fields.FloatField')())
        # Adding field 'BankRisk.complianceRiskb'
        db.add_column('erm_bankrisk', 'complianceRiskb',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'BankRisk.complianceRisk'
        db.alter_column('erm_bankrisk', 'complianceRisk', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):
        # Deleting field 'Risk.complianceRiskb'
        db.delete_column('erm_risk', 'complianceRiskb')


        # Changing field 'Risk.complianceRisk'
        db.alter_column('erm_risk', 'complianceRisk', self.gf('django.db.models.fields.BooleanField')())
        # Deleting field 'BankRisk.complianceRiskb'
        db.delete_column('erm_bankrisk', 'complianceRiskb')


        # Changing field 'BankRisk.complianceRisk'
        db.alter_column('erm_bankrisk', 'complianceRisk', self.gf('django.db.models.fields.BooleanField')())
