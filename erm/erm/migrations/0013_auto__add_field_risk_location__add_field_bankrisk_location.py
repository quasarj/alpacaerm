...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Risk.location'
        db.add_column('erm_risk', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BankRisk.location'
        db.add_column('erm_bankrisk', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Risk.location'
        db.delete_column('erm_risk', 'location')

        # Deleting field 'BankRisk.location'
        db.delete_column('erm_bankrisk', 'location')
