...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field riskTypes on 'BankRisk'
        db.create_table('erm_bankrisk_riskTypes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bankrisk', models.ForeignKey(orm['erm.bankrisk'], null=False)),
            ('risktype', models.ForeignKey(orm['erm.risktype'], null=False))
        ))
        db.create_unique('erm_bankrisk_riskTypes', ['bankrisk_id', 'risktype_id'])

        # Adding M2M table for field riskSources on 'BankRisk'
        db.create_table('erm_bankrisk_riskSources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bankrisk', models.ForeignKey(orm['erm.bankrisk'], null=False)),
            ('risksource', models.ForeignKey(orm['erm.risksource'], null=False))
        ))
        db.create_unique('erm_bankrisk_riskSources', ['bankrisk_id', 'risksource_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field riskTypes on 'BankRisk'
        db.delete_table('erm_bankrisk_riskTypes')

        # Removing M2M table for field riskSources on 'BankRisk'
        db.delete_table('erm_bankrisk_riskSources')
