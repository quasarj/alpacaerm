...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RiskManager'
        db.create_table('erm_riskmanager', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('erm', ['RiskManager'])
        ...
        # Adding M2M table for field riskManagers on 'BankRisk'
        db.create_table('erm_bankrisk_riskManagers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bankrisk', models.ForeignKey(orm['erm.bankrisk'], null=False)),
            ('riskmanager', models.ForeignKey(orm['erm.riskmanager'], null=False))
        ))
        db.create_unique('erm_bankrisk_riskManagers', ['bankrisk_id', 'riskmanager_id'])


    def backwards(self, orm):
        # Deleting model 'RiskManager'
        db.delete_table('erm_riskmanager')

        # Removing M2M table for field riskManagers on 'Risk'
        db.delete_table('erm_risk_riskManagers')

        # Removing M2M table for field riskManagers on 'BankRisk'
        db.delete_table('erm_bankrisk_riskManagers')
