...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BankRiskHistory.bank'
        db.delete_column('erm_bankriskhistory', 'bank_id')

        # Adding field 'BankRiskHistory.bankRisk'
        db.add_column('erm_bankriskhistory', 'bankRisk',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['erm.BankRisk']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BankRiskHistory.bank'
        raise RuntimeError("Cannot reverse this migration. 'BankRiskHistory.bank' and its values cannot be restored.")
        # Deleting field 'BankRiskHistory.bankRisk'
        db.delete_column('erm_bankriskhistory', 'bankRisk_id')
    ...
    models = {
        ...
        'erm.bankriskhistory': {
            ...
            'riskText': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'riskType': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['erm.RiskType']", 'null': 'True'}),
            'saved_date': ('django.db.models.fields.DateField', [], {}),
            'strategicRisk': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'strategicRiskWeight': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'threat': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'trend': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
