...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field riskManagers on 'Risk'
        db.delete_table('erm_risk_riskManagers')

        # Removing M2M table for field riskTypes on 'Risk'
        db.delete_table('erm_risk_riskTypes')

        # Removing M2M table for field riskSources on 'Risk'
        db.delete_table('erm_risk_riskSources')


    def backwards(self, orm):
        # Adding model 'Risk'
        db.create_table('erm_risk', (
            ('riskRating', self.gf('django.db.models.fields.FloatField')(default=0)),
            ...
            ('lastCompositeRisk', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('compositeRisk', self.gf('django.db.models.fields.FloatField')(default=0)),
            ...
            ('lastRiskRating', self.gf('django.db.models.fields.FloatField')(default=0)),
        ...
        # Adding M2M table for field riskManagers on 'Risk'
        db.create_table('erm_risk_riskManagers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('risk', models.ForeignKey(orm['erm.risk'], null=False)),
            ('riskmanager', models.ForeignKey(orm['erm.riskmanager'], null=False))
        ))
        db.create_unique('erm_risk_riskManagers', ['risk_id', 'riskmanager_id'])

        # Adding M2M table for field riskTypes on 'Risk'
        db.create_table('erm_risk_riskTypes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('risk', models.ForeignKey(orm['erm.risk'], null=False)),
            ('risktype', models.ForeignKey(orm['erm.risktype'], null=False))
        ))
        db.create_unique('erm_risk_riskTypes', ['risk_id', 'risktype_id'])

        # Adding M2M table for field riskSources on 'Risk'
        db.create_table('erm_risk_riskSources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('risk', models.ForeignKey(orm['erm.risk'], null=False)),
            ('risksource', models.ForeignKey(orm['erm.risksource'], null=False))
        ))
        db.create_unique('erm_risk_riskSources', ['risk_id', 'risksource_id'])
    ...
    models = {
        ...
        'erm.riskprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'risks': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['erm.BankRisk']", 'symmetrical': 'False'})
        },
        'erm.risksource': {
