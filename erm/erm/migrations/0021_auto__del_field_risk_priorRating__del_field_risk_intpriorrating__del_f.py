...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BankRiskHistory.priorRating'
        db.delete_column('erm_bankriskhistory', 'priorRating')

        # Deleting field 'BankRiskHistory.intpriorrating'
        db.delete_column('erm_bankriskhistory', 'intpriorrating')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'BankRiskHistory.priorRating'
        db.add_column('erm_bankriskhistory', 'priorRating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'BankRiskHistory.intpriorrating'
        db.add_column('erm_bankriskhistory', 'intpriorrating',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)
