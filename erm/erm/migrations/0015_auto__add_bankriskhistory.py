...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('erm_bankriskhistory', (
            ...
            ('riskType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['erm.RiskType'], null=True)),
            ('riskSource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['erm.RiskSource'], null=True)),
            ('riskText', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('threat', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ('response', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ('mitigations', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ...
            ('frequencyDet', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ('priorRating', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('intpriorrating', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('trend', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True)),
            ('calInherentRiskRating', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('bank', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['erm.Bank'])),
            ('saved_date', self.gf('django.db.models.fields.DateField')()),
        ))
