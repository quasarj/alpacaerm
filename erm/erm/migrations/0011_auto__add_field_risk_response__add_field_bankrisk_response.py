...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Risk.response'
        db.add_column('erm_risk', 'response',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BankRisk.response'
        db.add_column('erm_bankrisk', 'response',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Risk.response'
        db.delete_column('erm_risk', 'response')

        # Deleting field 'BankRisk.response'
        db.delete_column('erm_bankrisk', 'response')
    ...
    models = {
        ...
        'erm.bankrisk': {
            ...
            'response': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
