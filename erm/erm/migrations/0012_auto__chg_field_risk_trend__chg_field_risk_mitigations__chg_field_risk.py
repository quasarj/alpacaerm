...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Risk.trend'
        db.alter_column('erm_risk', 'trend', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))
        ...
        # Changing field 'BankRisk.trend'
        db.alter_column('erm_bankrisk', 'trend', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Risk.trend'
        db.alter_column('erm_risk', 'trend', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Risk.mitigations'
        db.alter_column('erm_risk', 'mitigations', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Risk.comments'
        db.alter_column('erm_risk', 'comments', self.gf('django.db.models.fields.CharField')(max_length=900, null=True))

        # Changing field 'Risk.riskText'
        db.alter_column('erm_risk', 'riskText', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Risk.threat'
        db.alter_column('erm_risk', 'threat', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Risk.frequencyDet'
        db.alter_column('erm_risk', 'frequencyDet', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Risk.response'
        db.alter_column('erm_risk', 'response', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'BankRisk.trend'
        db.alter_column('erm_bankrisk', 'trend', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'BankRisk.mitigations'
        db.alter_column('erm_bankrisk', 'mitigations', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'BankRisk.comments'
        db.alter_column('erm_bankrisk', 'comments', self.gf('django.db.models.fields.CharField')(max_length=900, null=True))

        # Changing field 'BankRisk.riskText'
        db.alter_column('erm_bankrisk', 'riskText', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'BankRisk.threat'
        db.alter_column('erm_bankrisk', 'threat', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'BankRisk.frequencyDet'
        db.alter_column('erm_bankrisk', 'frequencyDet', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'BankRisk.response'
        db.alter_column('erm_bankrisk', 'response', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
