...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bank.report_risk_ass_ratings_message'
        db.add_column('erm_bank', 'report_risk_ass_ratings_message',
                      self.gf('django.db.models.fields.CharField')(default='No text', max_length=5000),
                      keep_default=False)

        # Adding field 'Bank.report_risk_scoring_by_source_message'
        db.add_column('erm_bank', 'report_risk_scoring_by_source_message',
                      self.gf('django.db.models.fields.CharField')(default='No text', max_length=5000),
                      keep_default=False)

        # Adding field 'Bank.report_vendor_ass_message'
        db.add_column('erm_bank', 'report_vendor_ass_message',
                      self.gf('django.db.models.fields.CharField')(default='No text', max_length=5000),
                      keep_default=False)

        # Adding field 'Bank.report_dist_by_type_message'
        db.add_column('erm_bank', 'report_dist_by_type_message',
                      self.gf('django.db.models.fields.CharField')(default='No text', max_length=5000),
                      keep_default=False)

        # Adding field 'Bank.report_class_by_bu_message'
        db.add_column('erm_bank', 'report_class_by_bu_message',
                      self.gf('django.db.models.fields.CharField')(default='No text', max_length=5000),
                      keep_default=False)

        # Adding field 'Bank.report_action_items_summary_message'
        db.add_column('erm_bank', 'report_action_items_summary_message',
                      self.gf('django.db.models.fields.CharField')(default='No text', max_length=5000),
                      keep_default=False)

        # Adding field 'Bank.report_summary_conclusions_message'
        db.add_column('erm_bank', 'report_summary_conclusions_message',
                      self.gf('django.db.models.fields.CharField')(default='No text', max_length=5000),
                      keep_default=False)

        # Adding field 'Bank.report_footer_message'
        db.add_column('erm_bank', 'report_footer_message',
                      self.gf('django.db.models.fields.CharField')(default='No text', max_length=5000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bank.report_risk_ass_ratings_message'
        db.delete_column('erm_bank', 'report_risk_ass_ratings_message')

        # Deleting field 'Bank.report_risk_scoring_by_source_message'
        db.delete_column('erm_bank', 'report_risk_scoring_by_source_message')

        # Deleting field 'Bank.report_vendor_ass_message'
        db.delete_column('erm_bank', 'report_vendor_ass_message')

        # Deleting field 'Bank.report_dist_by_type_message'
        db.delete_column('erm_bank', 'report_dist_by_type_message')

        # Deleting field 'Bank.report_class_by_bu_message'
        db.delete_column('erm_bank', 'report_class_by_bu_message')

        # Deleting field 'Bank.report_action_items_summary_message'
        db.delete_column('erm_bank', 'report_action_items_summary_message')

        # Deleting field 'Bank.report_summary_conclusions_message'
        db.delete_column('erm_bank', 'report_summary_conclusions_message')

        # Deleting field 'Bank.report_footer_message'
        db.delete_column('erm_bank', 'report_footer_message')
