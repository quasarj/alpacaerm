...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exception.comments'
        db.alter_column('exception_exception', 'comments', self.gf('django.db.models.fields.CharField')(max_length=4000, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Exception.comments'
        raise RuntimeError("Cannot reverse this migration. 'Exception.comments' and its values cannot be restored.")
