...
DATABASES = {
    'default': {
        ...
        'NAME': 'alpacaerm',                      # Or path to database file if using sqlite3.
        'USER': 'alpacaerm',                      # Not used with sqlite3.
...
SECRET_KEY = '9=n%2z&amp;dmt16txxejj%w0!n!bmf%)e#a5_2*59w3zyx+ket3s!'
...
ROOT_URLCONF = 'ermproj.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ermproj.wsgi.application'
...
AUTH_PROFILE_MODULE = 'erm.UserProfile'
